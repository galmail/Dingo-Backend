class Api::V1::MessagesController < Api::BaseController
  ...
  def peers
    ...
    messages.each { |msg|
      ...
      conversations << { :id => msg.conversation_id, :user_id => peer.id, :user_name => peer.name, :user_pic => peer.photo_url, :event_name => msg.get_event_name, :last_msg_sent => msg.created_at, :last_msg_read => (msg.read and msg.receiver_id==current_user.id) }
    }
